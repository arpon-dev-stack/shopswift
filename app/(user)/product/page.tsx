    ...
    <div className="min-h-screen overflow-x-hidden bg-[#f8fafa] font-sans text-[#191c1d] selection:bg-[#fe9800]/30">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative hidden cursor-pointer p-2 text-white md:block">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <span className="absolute top-0 right-0 rounded-full bg-[#fe9800] px-1.5 text-[10px] font-bold text-[#2c1600]">
              3
            </span>
          </div>
        </div>
